...
INSERT INTO `jalur_masuk` VALUES ('3','SBMPTN');
...
CREATE TABLE `mahasiswa` (
  ...
  `jalur_masuk` enum('0','3','5') DEFAULT NULL,
  `nama` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  ...
  CONSTRAINT `mahasiswa_ibfk_2` FOREIGN KEY (`kode_fakultas`) REFERENCES `fakultas` (`kode`),
...
INSERT INTO `mahasiswa` VALUES ('06','H','07',2018,'3','Ardi S');
...
INSERT INTO `nim` VALUES ('Ardi S','H071181306');
...
-- Dump completed on 2019-10-30  2:04:13
